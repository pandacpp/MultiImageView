...
public class MultiImageView extends LinearLayout {
    ...
    public MultiImageView(Context context) {
        super(context);
        pxImagePadding = dip2px(context);// 图片间的间距
    }
    ...
    public void setDefaultImage(int mImage) {
        this.mDefaultImage = mImage;
    }
...
//  }
    ...
    private void initImageLayoutParams() {
        ...
        onePicPara = new LayoutParams(pxOneMaxWandH, 600);
    ...
    private ImageView createImageView(final int position, final boolean isMultiImage) {
        ...
        if (isMultiImage) {
            ...
            // 加载网络图片/设置图片显示
            Glide.with(getContext()).load(url).placeholder(mDefaultImage).error(mDefaultImage).into(imageView);
        } else {
